  ...
  const onSearch = (e) => {
    ...
    if (keyV === '') setUserList(totalUserList);
        ...
        totalUserList.forEach(element => {
           if (element.email.toLowerCase().indexOf(keyV.toLowerCase()) > -1 || element.username.toLowerCase().indexOf(keyV.toLowerCase()) > -1) {
                ...
                <CRow>
                    ...
                    <CCol sm="12" md="5" lg="5">
                        <CInputGroup className="admin-search pr-0 mr-0">
                            <CInput value={searchUsernameOrEmail} onChange={onSearch} placeholder="User username or Email" />
                ...
                { userList &&
                  userList.map(userItem => (
                    <tr>
                      ...
                      <td className="text-center">
                        { userItem.is_active ? 'Active' : 'Pending' }
                      </td>
                      <td className="text-center">
